...
namespace NetSDKCS
{
    public static class NETClient
    {
        ...
        public static bool GetNewDevConfig(IntPtr lLoginID, Int32 lChannel, string strCommand, ref object[] objs, Type typeName, int waittime, IntPtr pReserved = new IntPtr())
        {
            ...
            UInt32 nInBufSize = 20 * 1024 * 1024;
        ...
        /// </summary>
        /// <returns>TRUE表示成功 FALSE表示失败</returns>
        public static bool GetStorageDeviceInfo(IntPtr lLoginID, IntPtr pszDevName, ref NET_STORAGE_DEVICE pDevice, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetStorageDeviceInfo(lLoginID, pszDevName, ref pDevice, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 注册集中式多门控制校验函数订阅
        /// Sign up for a centralized multi-gate control check function subscription
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstInParam">[in] pstInParam 接口输入参数; [in] pstInParam Input parameter of the interface</param>
        /// <param name="pstOutParam">[out] pstOutParam 接口输出参数; [out] pstOutParam Indicates the output parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>返回订阅句柄; Returns the subscription handle</returns>
        public static IntPtr AttachCheckCentraMultiDoorCtrl(IntPtr lLoginID, ref NET_IN_ATTACH_CHECK_CENTRA_MULTI_DOOR_CTRL_INFO pstInParam, ref NET_OUT_ATTACH_CHECK_CENTRA_MULTI_DOOR_CTRL_INFO pstOutParam, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AttachCheckCentraMultiDoorCtrl(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 注册集中式多门控制校验函数退订
        /// register centralized multi-gate control check function unsubscribe
        /// </summary>
        /// <param name="lCheckCentraMultiDoorCtrlHandle">[in] lCheckCentraMultiDoorCtrlHandle 订阅句柄; [in] lCheckCentraMultiDoorCtrlHandle Subscription handle</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE Indicates success. FALSE Indicates failure</returns>
        public static bool DetachCheckCentraMultiDoorCtrl(IntPtr lCheckCentraMultiDoorCtrlHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DetachCheckCentraMultiDoorCtrl(lCheckCentraMultiDoorCtrlHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 中心设置反潜规则配置给下级设备
        /// center to set anti-submarine rules and configure them for lower-level devices
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口入参; [in] pstuInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口出参; [out] pstuOutParam Indicates the outgoing parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE Indicates success. FALSE Indicates failure</returns>
        public static bool SetAntiSubmarineRuleCfg(IntPtr lLoginID, ref NET_IN_ANTI_SUBMARINE_RULE_CFG_INFO pstuInParam, ref NET_OUT_ANTI_SUBMARINE_RULE_CFG_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetAntiSubmarineRuleCfg(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 中心设置校验结果给下级设备
        /// center sets the verification result to the lower-level devices
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口入参; [in] pstuInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口出参; [out] pstuOutParam Indicates the outgoing parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE Indicates success. FALSE Indicates failure</returns>
        public static bool SetCheckResultByCentra(IntPtr lLoginID, ref NET_IN_CENTRA_CHECK_RESULT_INFO pstuInParam, ref NET_OUT_CENTRA_CHECK_RESULT_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetCheckResultByCentra(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 给主控的下级设备设置互锁规则配置
        /// Configure interlock rules for the lower-level devices in the main control
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口入参; [in] pstuInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口出参; [out] pstuOutParam Indicates the outgoing parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE Indicates success. FALSE Indicates failure</returns>
        public static bool SetInterLockRule(IntPtr lLoginID, ref NET_IN_INTER_LOCK_RULE_INFO pstuInParam, ref NET_OUT_INTER_LOCK_RULE_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetInterLockRule(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 设置文件的URL,并从此地址下载文件
        /// Set the URL of the file and download the file from this address
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数，对应NET_IN_SET_FILE_MANAGER_DOWNLOAD_URLS; [in] pstuInParam Interface input parameters, corresponding to NET_IN_SET_FILE_MANAGER_DOWNLOAD_URLS</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数; [out] pstuOutParam Interface output parameters</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
        public static bool SetFileManagerDownLoadUrls(IntPtr lLoginID, IntPtr pstuInParam, ref NET_OUT_SET_FILE_MANAGER_DOWNLOAD_URLS pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetFileManagerDownLoadUrls(lLoginID, pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 注册上传下载文件状态观察接口
        /// Registration, upload, download file status observation interface
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数; [in] pstuInParam Interface input parameters</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数; [out] pstuOutParam Interface output parameters</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>返回订阅句柄; LLONG lAttachHandle Attach Handle</returns>
        public static IntPtr AttachFileLoadState(IntPtr lLoginID, ref NET_IN_ATTACH_FILE_LOAD_STATE pstuInParam, ref NET_OUT_ATTACH_FILE_LOAD_STATE pstuOutParam, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AttachFileLoadState(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 注销上传下载文件状态观察接口
        /// Cancel the upload and download file status observation interface
        /// </summary>
        /// <param name="lAttachHandle">[in] lAttachHandle 订阅句柄; [in] lAttachHandle Attach Handle</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
        public static bool DetachFileLoadState(IntPtr lAttachHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DetachFileLoadState(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数; [in] pstuInParam Interface input parameters</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数，对应NET_OUT_GET_FILE_LIST; [out] pstuOutParam Interface output parameters, corresponding to NET_OUT_GET_FILE_LIST</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
        public static bool GetFileList(IntPtr lLoginID, ref NET_IN_GET_FILE_LIST pstuInParam, IntPtr pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetFileList(lLoginID, ref pstuInParam, pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 开始播放节目
        /// Start Play Programmer
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数，对应NET_IN_START_SPEAKER_PROGRAM_MANAGER_PLAY; [in] pstuInParam Interface input parameters, corresponding to NET_IN_START_SPEAKER_PROGRAM_MANAGER_PLAY</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数; [out] pstuOutParam Interface output parameters</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
        public static bool StartSpeakerProgramManagerPlay(IntPtr lLoginID, IntPtr pstuInParam, ref NET_OUT_START_SPEAKER_PROGRAM_MANAGER_PLAY pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_StartSpeakerProgramManagerPlay(lLoginID, pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
        public static bool StopSpeakerProgramManagerPlay(IntPtr lLoginID, ref NET_IN_STOP_SPEAKER_PROGRAM_MANAGER_PLAY pstuInParam, ref NET_OUT_STOP_SPEAKER_PROGRAM_MANAGER_PLAY pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_StopSpeakerProgramManagerPlay(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>返回订阅句柄; LLONG lAttachHandle Attach Handle</returns>
        public static IntPtr AttachSpeakerProgramManagerPlayState(IntPtr lLoginID, ref NET_IN_ATTACH_SPEAKER_PROGRAM_MANAGER_PLAY_STATE pstuInParam, ref NET_OUT_ATTACH_SPEAKER_PROGRAM_MANAGER_PLAY_STATE pstuOutParam, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AttachSpeakerProgramManagerPlayState(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="lAttachHandle">[in] lAttachHandle 订阅句柄; [in] lAttachHandle Attach Handle</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
        public static bool DetachSpeakerProgramManagerPlayState(IntPtr lAttachHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DetachSpeakerProgramManagerPlayState(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE表示成功 FALSE表示失败</returns>
        public static bool RenameRemoteFile(IntPtr lLoginID, ref NET_A_IN_RENAME_REMOTE_FILE pInParam, ref NET_A_OUT_RENAME_REMOTE_FILE pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_RenameRemoteFile(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE表示成功 FALSE表示失败</returns>
        public static bool GetSmokeData(IntPtr lLoginID, ref NET_IN_GET_SMOKE_DATA pInParam, ref NET_OUT_GET_SMOKE_DATA pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetSmokeData(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE表示成功 FALSE表示失败</returns>
        public static bool OperateRaid(IntPtr lLoginID, EM_A_NET_RAID_OPERATE_TYPE emType, IntPtr pInBuf, IntPtr pOutBuf, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_OperateRaid(lLoginID, emType, pInBuf, pOutBuf, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 远程消音（消防）
        /// Remote erasure (fire control)
        /// </summary>
        /// <returns>TRUE表示成功 FALSE表示失败</returns>
        public static bool SmokeRemoteErasure(IntPtr lLoginID, ref NET_IN_SMOKE_REMOTE_ERASURE_INFO pInParam, ref NET_OUT_SMOKE_REMOTE_ERASURE_INFO pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SmokeRemoteErasure(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 四合一烟感平台下发整机重启
        /// The four in one smoke sensing platform sends out and the whole machine restarts
        /// </summary>
        /// <returns>TRUE表示成功 FALSE表示失败</returns>
        public static bool RebootDevice(IntPtr lLoginID, ref NET_IN_REBOOT_DEVICE pInParam, ref NET_OUT_REBOOT_DEVICE pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_RebootDevice(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 获取远程ipspeaker能力集信息
        /// Get Caps Of The Remote IPSpeaker Device
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数，对应 NET_IN_IPSPEAKER_GET_CAPS; [in] pstuInParam Interface input parameters, corresponding to NET_IN_IPSPEAKER_GET_CAPS</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数，对应 NET_OUT_IPSPEAKER_GET_CAPS; [out] pstuOutParam Interface output parameters, corresponding to NET_OUT_IPSPEAKER_GET_CAPS</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
		public static bool IpSpeakerGetCaps(IntPtr lLoginID,ref NET_IN_IPSPEAKER_GET_CAPS pstuInParam, ref NET_OUT_IPSPEAKER_GET_CAPS pstuOutParam, int nWaitTime)
		{
            bool result = false;
            result = OriginalSDK.CLIENT_IpSpeakerGetCaps(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 获取远程ipspeaker音量参数
        /// Get Volume Parameters From Remote IPSpeaker Device
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数，对应 NET_IN_IPSPEAKER_GET_VOLUME_PARAMS; [in] pstuInParam Interface input parameters, corresponding to NET_IN_IPSPEAKER_GET_VOLUME_PARAMS</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数，对应 NET_OUT_IPSPEAKER_GET_VOLUME_PARAMS; [out] pstuOutParam Interface output parameters, corresponding to NET_OUT_IPSPEAKER_GET_VOLUME_PARAMS</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
		public static bool IpSpeakerGetVolumeParams(IntPtr lLoginID,ref NET_IN_IPSPEAKER_GET_VOLUME_PARAMS pstuInParam, ref NET_OUT_IPSPEAKER_GET_VOLUME_PARAMS pstuOutParam, int nWaitTime)
		{
            bool result = false;
            result = OriginalSDK.CLIENT_IpSpeakerGetVolumeParams(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 设置远程ipspeaker音量参数
        /// Set The Remote IPSpeaker's Volume Parameters
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数，对应 NET_IN_IPSPEAKER_SET_VOLUME_PARAMS; [in] pstuInParam Interface input parameters, corresponding to NET_IN_IPSPEAKER_SET_VOLUME_PARAMS</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数，对应 NET_OUT_IPSPEAKER_SET_VOLUME_PARAMS; [out] pstuOutParam Interface output parameters, corresponding to NET_OUT_IPSPEAKER_SET_VOLUME_PARAMS</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
		public static bool IpSpeakerSetVolumeParams(IntPtr lLoginID,ref NET_IN_IPSPEAKER_SET_VOLUME_PARAMS pstuInParam, ref NET_OUT_IPSPEAKER_SET_VOLUME_PARAMS pstuOutParam, int nWaitTime)
		{
            bool result = false;
            result = OriginalSDK.CLIENT_IpSpeakerSetVolumeParams(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }		

        /// <summary>
        /// 获取远程ipspeaker设备的音频文件
        /// Get Audio File List From Remote IPSpeaker Device
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数，对应 NET_IN_IPSPEAKER_GET_AUDIO_FILES; [in] pstuInParam Interface input parameters, corresponding to NET_IN_IPSPEAKER_GET_AUDIO_FILES</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数，对应 NET_OUT_IPSPEAKER_GET_AUDIO_FILES; [out] pstuOutParam Interface output parameters, corresponding to NET_OUT_IPSPEAKER_GET_AUDIO_FILES</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
		public static bool IpSpeakerGetAudioFiles(IntPtr lLoginID,ref NET_IN_IPSPEAKER_GET_AUDIO_FILES pstuInParam, ref NET_OUT_IPSPEAKER_GET_AUDIO_FILES pstuOutParam, int nWaitTime)
		{
            bool result = false;
            result = OriginalSDK.CLIENT_IpSpeakerGetAudioFiles(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }	
		
        /// <summary>
        /// 开始远程ipspeaker设备的音频文件播放
        /// Start The Remote IPSpeaker Audio Playback
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数，对应 NET_IN_IPSPEAKER_START_PLAY_AUDIO_FILE; [in] pstuInParam Interface input parameters, corresponding to NET_IN_IPSPEAKER_START_PLAY_AUDIO_FILE</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数，对应 NET_OUT_IPSPEAKER_START_PLAY_AUDIO_FILE; [out] pstuOutParam Interface output parameters, corresponding to NET_OUT_IPSPEAKER_START_PLAY_AUDIO_FILE</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
		public static bool IpSpeakerStartPlayAudioFile(IntPtr lLoginID,ref NET_IN_IPSPEAKER_START_PLAY_AUDIO_FILE pstuInParam, ref NET_OUT_IPSPEAKER_START_PLAY_AUDIO_FILE pstuOutParam, int nWaitTime)
		{
            bool result = false;
            result = OriginalSDK.CLIENT_IpSpeakerStartPlayAudioFile(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }	
		
        /// <summary>
        /// 停止远程ipspeaker设备的音频文件播放
        /// Stop The Remote IPSpeaker Audio Playback
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数，对应 NET_IN_IPSPEAKER_STOP_PLAY_AUDIO_FILE; [in] pstuInParam Interface input parameters, corresponding to NET_IN_IPSPEAKER_STOP_PLAY_AUDIO_FILE</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数，对应 NET_OUT_IPSPEAKER_STOP_PLAY_AUDIO_FILE; [out] pstuOutParam Interface output parameters, corresponding to NET_OUT_IPSPEAKER_STOP_PLAY_AUDIO_FILE</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
		public static bool IpSpeakerStopPlayAudioFile(IntPtr lLoginID,ref NET_IN_IPSPEAKER_STOP_PLAY_AUDIO_FILE pstuInParam, ref NET_OUT_IPSPEAKER_STOP_PLAY_AUDIO_FILE pstuOutParam, int nWaitTime)
		{
            bool result = false;
            result = OriginalSDK.CLIENT_IpSpeakerStopPlayAudioFile(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }		

        /// <summary>
		/// 删除远程ipspeaker设备的音频文件
        /// Delete Audio File From Remote IPSpeaker Device
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数，对应 NET_IN_IPSPEAKER_DELETE_AUDIO_FILES; [in] pstuInParam Interface input parameters, corresponding to NET_IN_IPSPEAKER_DELETE_AUDIO_FILES</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数，对应 NET_OUT_IPSPEAKER_DELETE_AUDIO_FILES; [out] pstuOutParam Interface output parameters, corresponding to NET_OUT_IPSPEAKER_DELETE_AUDIO_FILES</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
		public static bool IpSpeakerDeleteAudioFiles(IntPtr lLoginID,ref NET_IN_IPSPEAKER_DELETE_AUDIO_FILES pstuInParam, ref NET_OUT_IPSPEAKER_DELETE_AUDIO_FILES pstuOutParam, int nWaitTime)
		{
            bool result = false;
            result = OriginalSDK.CLIENT_IpSpeakerDeleteAudioFiles(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }		

        /// <summary>
		/// 上传音频文件到远程ipspeaker设备
        /// Upload Audio File To Remote IPSpeaker Device
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数，对应 NET_IN_IPSPEAKER_UPLOAD_AUDIO_FILE; [in] pstuInParam Interface input parameters, corresponding to NET_IN_IPSPEAKER_UPLOAD_AUDIO_FILE</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数，对应 NET_OUT_IPSPEAKER_UPLOAD_AUDIO_FILE; [out] pstuOutParam Interface output parameters, corresponding to NET_OUT_IPSPEAKER_UPLOAD_AUDIO_FILE</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
		public static bool IpSpeakerUploadAudioFile(IntPtr lLoginID,ref NET_IN_IPSPEAKER_UPLOAD_AUDIO_FILE pstuInParam, ref NET_OUT_IPSPEAKER_UPLOAD_AUDIO_FILE pstuOutParam, int nWaitTime)
		{
            bool result = false;
            result = OriginalSDK.CLIENT_IpSpeakerUploadAudioFile(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pInParam 接口输入参数，对应 NET_IN_ATTACH_DEVICE_STATE; [in] pInParam Interface input parameters, corresponding to NET_IN_ATTACH_DEVICE_STATE</param>
        /// <param name="pOutParam">[out] pOutParam 接口输出参数，对应 NET_OUT_ATTACH_DEVICE_STATE; [out] pOutParam Interface output parameters, corresponding to NET_OUT_ATTACH_DEVICE_STATE</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>failed return Intptr.Zero, successful return lAttachHandle; 失败返回Intptr.Zero 成功返回操作句柄</returns>
		public static IntPtr AttachDeviceState(IntPtr lLoginID, ref NET_IN_ATTACH_DEVICE_STATE pInParam, ref NET_OUT_ATTACH_DEVICE_STATE pOutParam, int nWaitTime)
		{
			IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AttachDeviceState(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }		
        ...
        /// <param name="lAttachHandle">[in] lAttachHandle 订阅句柄; [in] lAttachHandle Attach handle</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
		public static bool DetachDeviceState(IntPtr lAttachHandle)
		{
            bool result = false;
            result = OriginalSDK.CLIENT_DetachDeviceState(lAttachHandle);
            NetGetLastError(result);
            return result;
        }		
        ...
        /// <summary>
		/// 使用设备概要信息异步添加设备
        ///  Add Device By Summary Info
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pInParam 接口输入参数，对应 NET_IN_ASYNC_ADD_DEVICE_BY_SUMMARY; [in] pInParam Interface input parameters, corresponding to NET_IN_ASYNC_ADD_DEVICE_BY_SUMMARY</param>
        /// <param name="pOutParam">[out] pOutParam 接口输出参数，对应 NET_OUT_ASYNC_ADD_DEVICE_BY_SUMMARY; [out] pOutParam Interface output parameters, corresponding to NET_OUT_ASYNC_ADD_DEVICE_BY_SUMMARY</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
		public static bool AsyncAddDeviceBySummary(IntPtr lLoginID, ref NET_IN_ASYNC_ADD_DEVICE_BY_SUMMARY pInParam, ref NET_OUT_ASYNC_ADD_DEVICE_BY_SUMMARY pOutParam, int nWaitTime)
		{
            bool result = false;
            result = OriginalSDK.CLIENT_AsyncAddDeviceBySummary(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }	
		...
		/// <summary>
		/// 获取已添加的IoT设备状态
        ///  Get The Iot Device Infos
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数，对应 NET_IN_GET_IOT_DEVICE_INFO; [in] pstuInParam Interface input parameters, corresponding to NET_IN_GET_IOT_DEVICE_INFO</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数，对应 NET_OUT_GET_IOT_DEVICE_INFO; [out] pstuOutParam Interface output parameters, corresponding to NET_OUT_GET_IOT_DEVICE_INFO</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
		public static bool GetIoTDeviceInfo(IntPtr lLoginID, ref NET_IN_GET_IOT_DEVICE_INFO pstuInParam, ref NET_OUT_GET_IOT_DEVICE_INFO pstuOutParam, int nWaitTime)
		{
            bool result = false;
            result = OriginalSDK.CLIENT_GetIoTDeviceInfo(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }		
    ...
    /// <summary>
    /// 注册集中式多门控制校验函数订阅回调函数原型, lCheckCentraMultiDoorCtrlHandle 为 CLIENT_AttachCheckCentraMultiDoorCtrl 接口的返回值
    /// registers the central multi-gate control check function to subscribe to the callback function prototype. lCheckCentraMultiDoorCtrlHandle is the return value of the CLIENT_AttachCheckCentraMultiDoorCtrl interface
    /// </summary>
    /// <param name="lCheckCentraMultiDoorCtrlHandle">[out] lCheckCentraMultiDoorCtrlHandle 订阅句柄; [out] lCheckCentraMultiDoorCtrlHandle Subscription handle</param>
    /// <param name="pstuMultiDoorCtrlCheckNotifyInfo">[out] pstuMultiDoorCtrlCheckNotifyInfo 多门控制校验结果; [out] pstuMultiDoorCtrlCheckNotifyInfo Multi-door control verification result</param>
    /// <param name="dwUser">[out] dwUser 用户信息; [out] dwUser user information</param>
    /// <returns>void; void</returns>
    public delegate void fNotifyCentraMultiDoorCtrlCheck(IntPtr lCheckCentraMultiDoorCtrlHandle, IntPtr pstuMultiDoorCtrlCheckNotifyInfo, IntPtr dwUser);
    /// <summary>
    /// 向客户端发送状态, lAttachHandle 为 CLIENT_AttachFileLoadState 接口的返回值
    /// Send status to the client, lAttachHandle is the return value of the CLIENT_AttachFileLoadState interface
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle 订阅句柄; [out] lAttachHandle Subscription handle</param>
    /// <param name="pstuNotifyInfo">[out] pstuPlayState 订阅的播放状态信息，对应NET_NOTIFY_FILE_LOAD_STATE; [out] pstuPlayState notification information, corresponding to NET_NOTIFY_FILE_LOAD_STATE</param>
    /// <param name="dwUser">[out] dwUser 用户信息; [out] dwUser user information</param>
    /// <returns>void; void</returns>
    public delegate void fNotifyFileLoadState(IntPtr lAttachHandle, IntPtr pstuNotifyInfo, IntPtr dwUser);

    /// <summary>
    /// 订阅播放状态信息回调函数原型, lAttachHandle 为 CLIENT_AttachSpeakerProgramManagerPlayState 接口的返回值
    /// Attach Play State Notify Info
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle 订阅句柄; [out] lAttachHandle Subscription handle</param>
    /// <param name="pstuPlayState">[out] pstuPlayState 订阅的播放状态信息，对应NET_NOTIFY_SPEAKER_PROGRAM_MANAGER_PLAY_STATE; [out] pstuPlayState notification information, corresponding to NET_NOTIFY_SPEAKER_PROGRAM_MANAGER_PLAY_STATE</param>
    /// <param name="dwUser">[out] dwUser 用户信息; [out] dwUser user information</param>
    /// <returns>void; void</returns>
    public delegate void fNotifySpeakerProgramManagerPlayState(IntPtr lAttachHandle, IntPtr pstuPlayState, IntPtr dwUser);
	
	/// <summary>
    /// 向设备注册的回调函数原型, lAttachHandle 为 CLIENT_AttachDeviceState 接口的返回值
    ...
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle 订阅句柄; [out] lAttachHandle Subscription handle</param>
    /// <param name="pstDeviceState">[out] pstDeviceState 订阅的设备状态信息，对应 NET_CB_ATTACH_DEVICE_STATE; [out] pstDeviceState notification information, corresponding to NET_CB_ATTACH_DEVICE_STATE</param>
    /// <param name="dwUser">[out] dwUser 用户信息; [out] dwUser user information</param>
    /// <returns>void; void</returns>
	public delegate void fDeviceStateCallBack(IntPtr lAttachHandle, IntPtr pstDeviceState, IntPtr dwUser);
    #endregion //<< delegate >>
}
