...
namespace NetSDKCS
{
    internal static class OriginalSDK
    {
        ...
        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_GetStorageDeviceInfo(IntPtr lLoginID, IntPtr pszDevName, ref NET_STORAGE_DEVICE pDevice, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern IntPtr CLIENT_AttachCheckCentraMultiDoorCtrl(IntPtr lLoginID, ref NET_IN_ATTACH_CHECK_CENTRA_MULTI_DOOR_CTRL_INFO pstInParam, ref NET_OUT_ATTACH_CHECK_CENTRA_MULTI_DOOR_CTRL_INFO pstOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_DetachCheckCentraMultiDoorCtrl(IntPtr lCheckCentraMultiDoorCtrlHandle);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_SetAntiSubmarineRuleCfg(IntPtr lLoginID, ref NET_IN_ANTI_SUBMARINE_RULE_CFG_INFO pstuInParam, ref NET_OUT_ANTI_SUBMARINE_RULE_CFG_INFO pstuOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_SetCheckResultByCentra(IntPtr lLoginID, ref NET_IN_CENTRA_CHECK_RESULT_INFO pstuInParam, ref NET_OUT_CENTRA_CHECK_RESULT_INFO pstuOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_SetInterLockRule(IntPtr lLoginID, ref NET_IN_INTER_LOCK_RULE_INFO pstuInParam, ref NET_OUT_INTER_LOCK_RULE_INFO pstuOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_SetFileManagerDownLoadUrls(IntPtr lLoginID, IntPtr pstuInParam, ref NET_OUT_SET_FILE_MANAGER_DOWNLOAD_URLS pstuOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern IntPtr CLIENT_AttachFileLoadState(IntPtr lLoginID, ref NET_IN_ATTACH_FILE_LOAD_STATE pstuInParam, ref NET_OUT_ATTACH_FILE_LOAD_STATE pstuOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_DetachFileLoadState(IntPtr lAttachHandle);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_GetFileList(IntPtr lLoginID, ref NET_IN_GET_FILE_LIST pstuInParam, IntPtr pstuOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_StartSpeakerProgramManagerPlay(IntPtr lLoginID, IntPtr pstuInParam, ref NET_OUT_START_SPEAKER_PROGRAM_MANAGER_PLAY pstuOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_StopSpeakerProgramManagerPlay(IntPtr lLoginID, ref NET_IN_STOP_SPEAKER_PROGRAM_MANAGER_PLAY pstuInParam, ref NET_OUT_STOP_SPEAKER_PROGRAM_MANAGER_PLAY pstuOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern IntPtr CLIENT_AttachSpeakerProgramManagerPlayState(IntPtr lLoginID, ref NET_IN_ATTACH_SPEAKER_PROGRAM_MANAGER_PLAY_STATE pstuInParam, ref NET_OUT_ATTACH_SPEAKER_PROGRAM_MANAGER_PLAY_STATE pstuOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_DetachSpeakerProgramManagerPlayState(IntPtr lAttachHandle);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_RenameRemoteFile(IntPtr lLoginID, ref NET_A_IN_RENAME_REMOTE_FILE pInParam, ref NET_A_OUT_RENAME_REMOTE_FILE pOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_GetSmokeData(IntPtr lLoginID, ref NET_IN_GET_SMOKE_DATA pInParam, ref NET_OUT_GET_SMOKE_DATA pOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_OperateRaid(IntPtr lLoginID, EM_A_NET_RAID_OPERATE_TYPE emType, IntPtr pInBuf, IntPtr pOutBuf, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_SmokeRemoteErasure(IntPtr lLoginID, ref NET_IN_SMOKE_REMOTE_ERASURE_INFO pInParam, ref NET_OUT_SMOKE_REMOTE_ERASURE_INFO pOutParam, int nWaitTime);

        [DllImport(LIBRARYNETSDK)]
        public static extern bool CLIENT_RebootDevice(IntPtr lLoginID, ref NET_IN_REBOOT_DEVICE pInParam, ref NET_OUT_REBOOT_DEVICE pOutParam, int nWaitTime);
		
		[DllImport(LIBRARYNETSDK)]
		public static extern bool CLIENT_IpSpeakerGetCaps(IntPtr lLoginID,ref NET_IN_IPSPEAKER_GET_CAPS pstuInParam, ref NET_OUT_IPSPEAKER_GET_CAPS pstuOutParam, int nWaitTime);
		
		[DllImport(LIBRARYNETSDK)]
		public static extern bool CLIENT_IpSpeakerGetVolumeParams(IntPtr lLoginID,ref NET_IN_IPSPEAKER_GET_VOLUME_PARAMS pstuInParam, ref NET_OUT_IPSPEAKER_GET_VOLUME_PARAMS pstuOutParam, int nWaitTime);
		
		[DllImport(LIBRARYNETSDK)]
		public static extern bool CLIENT_IpSpeakerSetVolumeParams(IntPtr lLoginID,ref NET_IN_IPSPEAKER_SET_VOLUME_PARAMS pstuInParam, ref NET_OUT_IPSPEAKER_SET_VOLUME_PARAMS pstuOutParam, int nWaitTime);
		
		[DllImport(LIBRARYNETSDK)]
		public static extern bool CLIENT_IpSpeakerGetAudioFiles(IntPtr lLoginID, ref NET_IN_IPSPEAKER_GET_AUDIO_FILES pstuInParam, ref NET_OUT_IPSPEAKER_GET_AUDIO_FILES pstuOutParam, int nWaitTime);
		
		[DllImport(LIBRARYNETSDK)]
		public static extern bool CLIENT_IpSpeakerStartPlayAudioFile(IntPtr lLoginID,ref NET_IN_IPSPEAKER_START_PLAY_AUDIO_FILE pstuInParam, ref NET_OUT_IPSPEAKER_START_PLAY_AUDIO_FILE pstuOutParam, int nWaitTime);
		
		[DllImport(LIBRARYNETSDK)]
		public static extern bool CLIENT_IpSpeakerStopPlayAudioFile(IntPtr lLoginID,ref NET_IN_IPSPEAKER_STOP_PLAY_AUDIO_FILE pstuInParam, ref NET_OUT_IPSPEAKER_STOP_PLAY_AUDIO_FILE pstuOutParam, int nWaitTime);
		
		[DllImport(LIBRARYNETSDK)]
		public static extern bool CLIENT_IpSpeakerDeleteAudioFiles(IntPtr lLoginID,ref NET_IN_IPSPEAKER_DELETE_AUDIO_FILES pstuInParam, ref NET_OUT_IPSPEAKER_DELETE_AUDIO_FILES pstuOutParam, int nWaitTime);
		
		[DllImport(LIBRARYNETSDK)]
		public static extern bool CLIENT_IpSpeakerUploadAudioFile(IntPtr lLoginID,ref NET_IN_IPSPEAKER_UPLOAD_AUDIO_FILE pstuInParam, ref NET_OUT_IPSPEAKER_UPLOAD_AUDIO_FILE pstuOutParam, int nWaitTime);

		[DllImport(LIBRARYNETSDK)]
		public static extern IntPtr CLIENT_AttachDeviceState(IntPtr lLoginID, ref NET_IN_ATTACH_DEVICE_STATE pInParam, ref NET_OUT_ATTACH_DEVICE_STATE pOutParam, int nWaitTime);
		
		[DllImport(LIBRARYNETSDK)]
		public static extern bool CLIENT_DetachDeviceState(IntPtr lAttachHandle);
		
		[DllImport(LIBRARYNETSDK)]
		public static extern bool CLIENT_AsyncAddDeviceBySummary(IntPtr lLoginID, ref NET_IN_ASYNC_ADD_DEVICE_BY_SUMMARY pInParam, ref NET_OUT_ASYNC_ADD_DEVICE_BY_SUMMARY pOutParam, int nWaitTime);
		
		[DllImport(LIBRARYNETSDK)]
		public static extern bool CLIENT_GetIoTDeviceInfo(IntPtr lLoginID, ref NET_IN_GET_IOT_DEVICE_INFO pstuInParam, ref NET_OUT_GET_IOT_DEVICE_INFO pstuOutParam, int nWaitTime);
